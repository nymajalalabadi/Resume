...
function barChartWithImg() {
  ...
  chart.data = [{
    ...
    "bullet": "../..//admin/images/user/user1-round.png"
  }, {
    "name": "علی",
    "points": 65456,
    "color": chart.colors.next(),
    "bullet": "../..//admin/images/user/user2-round.png"
  }, {
    "name": "محمد",
    "points": 45724,
    "color": chart.colors.next(),
    "bullet": "../..//admin/images/user/user3-round.png"
  }, {
    "name": "حسین",
    "points": 13654,
    "color": chart.colors.next(),
    "bullet": "../..//admin/images/user/user4-round.png"
  },
  {
    "name": "رضا",
    "points": 32589,
    "color": chart.colors.next(),
    "bullet": "../..//admin/images/user/user5-round.png"
  },
  {
    "name": "محسن",
    "points": 45895,
    "color": chart.colors.next(),
    "bullet": "../..//admin/images/user/user6-round.png"
  },
  ];
...
function mapBubble() {
  ...
  title.text = "[bold font-size: 20]جمعیت کشور در سال 2011[/]\nsource: Gapminder";
  ...
  var mapData = [
    { "id": "IN", "name": "هند", "value": 1241491960, "color": chart.colors.getIndex(0) },
    { "id": "JP", "name": "ژاپن", "value": 126497241, "color": chart.colors.getIndex(0) },
    { "id": "AU", "name": "استرالیا", "value": 22605732, "color": "#8aabb0" },
    { "id": "US", "name": "آمریکا", "value": 313085380, "color": chart.colors.getIndex(4) },
    { "id": "RU", "name": "روسیه", "value": 142835555, "color": chart.colors.getIndex(1) },
    { "id": "BR", "name": "برزیل", "value": 196655014, "color": chart.colors.getIndex(3) },
    { "id": "DZ", "name": "الجزایر", "value": 35980193, "color": chart.colors.getIndex(2) }
  ];
