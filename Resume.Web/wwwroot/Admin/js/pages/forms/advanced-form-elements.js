...
function initImageSelect() {
	/* select with image */
	$('#imgsel').formSelect();
	var data = [{ id: 1, name: "Option 1", url: "../..//admin/images/user/user1.jpg" }, { id: 2, name: "Option 2", url: "../..//admin/images/user/user2.jpg" }, { id: 3, name: "Option 3", url: "../..//admin/images/user/user3.jpg" }];
